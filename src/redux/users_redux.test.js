...
describe('Users reducer', () => {
  ...
  describe('Fetch users actions', () => {
    it('FETCH_USERS action gets users from server', () => {
      const mockState = {
        list: null,
        fetching: true,
        error: null
    ...
    it('FETCH_USERS_FAILURE action captures a failed request', () => {
      const mockState = {
        list: null,
        fetching: false,
        error: 'SERVER_ERROR'
    ...
    it('FETCH_USERS_SUCCESS action captures a success request', () => {
      const list = [{
        "id": 1,
        "name": "Leanne Graham",
        "username": "Bret",
